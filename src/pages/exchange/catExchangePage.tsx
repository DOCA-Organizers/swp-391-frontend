            ...
            <Card sx={{ minWidth: 275 }}>
              <CardContent>
                ...
                <Typography variant="body2">
                  Welcome to our Chat Exchange Forum, where canine enthusiasts
                  come together to facilitate the exchange of cats with care and
                  responsibility. This platform provides a space for individuals
                  looking to rehome their beloved pets or find new homes for
                  cats in need. Users can post adoption listings, share
                  information about their cats, and connect with potential
                  adopters.
                </Typography>
              </CardContent>
            </Card>
        ...
        <DialogContent placeholder="Content">
          <Grid container padding="0 16px">
            ...
            <Grid
              ...
              style={{ display: "flex", paddingTop: "10px" }}
            >
              <Typography style={titleStyle}>Cat type: </Typography>
              <Typography ml={1} style={textBodyStyle}>
                Dog
              </Typography>
            </Grid>
